...
![version: 0.1.2](https://img.shields.io/badge/version-0.1.2-475569)
...
Download `dossier-folders-0.1.2.tgz` from the [GitHub release](https://github.com/JimmyJammed/dossier-folders-web/releases/tag/v0.1.2), or run `npm run pack:library`.
Public npm publication is deferred; the badge above is the repository version.

```sh
npm install ./dossier-folders-0.1.2.tgz
```
